...
exports.getAllStats = exports.profileAsync = exports.profileSync = void 0;
let profilingData = {};
...
function profileSync(func, funcName = getFnName(func)) {
    return function __skipstack__wrappedWithSyncProfiler(...args) {
...
function profileAsync(func, funcName = getFnName(func)) {
    return async function __skipstack__wrappedWithProfiler(...args) {
        const profiler = startProfiler(func, funcName);
