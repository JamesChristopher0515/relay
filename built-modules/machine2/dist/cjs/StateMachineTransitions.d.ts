...
type TransitionReturnInner = StateContext | Observable<StateContext> | [StateContext, StateCleanupFn | undefined] | [Observable<StateContext>, StateCleanupFn];
type TransitionReturn = MaybePromise<TransitionReturnInner>;
export type StateTransition<TArgs, TState, GlobalState> = (args: TArgs, utils: {
    current: TState;
    state: GlobalState;
...
export {};
//# sourceMappingURL=StateMachineTransitions.d.ts.map