...
export interface ChatEngine<Models extends string = string> {
    getCompletionCost(completionCost: number, messages: ChatCompletionMessage[], settings: Pick<CompletionSettings<Models>, 'model' | 'max_tokens'>): Promise<{
        likelyCost: number;
        maxPossibleCost: number;
    }>;
    getChatCompletion(_messages: ChatCompletionMessage[], settings?: Partial<CompletionSettings<Models>>): Promise<{
        messages: Observable<{
