...
export const jsonObjectOrObject = (actualSchema) => z.union([
    actualSchema,
    z
        .string()
        .refine((val) => {
...
export const parsedIntOrNumberLiteral = (l) => z.union([
    z.literal(l),
    z
        .literal(String(l))
        .refine((val) => {
...
const dateRange = jsonObjectOrObject(z.object({
...
export const AssignedResourcesSchemas = {
    read: z.any(),
    create: z.object({
        type: z.enum(getAllResourceTypes()),
...
export const JourneyQuestionnaireStopData = (objectId) => z.object({
...
export const JourneyStopDataSchemas = (objectId) => {
    ...
    return mapValues(specific, (schema) => z.object({}).extend(schema.shape));
};
...
export var ClientInsightsWidgetTypes;
...
})(ClientInsightsWidgetTypes || (ClientInsightsWidgetTypes = {}));
export const ClientInsightsWidgetTypesVal = Object.values(ClientInsightsWidgetTypes);
 ...
 */
export function ClientInsightsWidgetSchemas(objectIdSchema) {
    const specific = {
        /**
        ...
        'questionnaire-result': z.object({
            ...
            appearance: z.enum(['timeline', 'latest']),
        }),
        ...
        relay: z.object({ appearance: z.enum(['default']) }),
...
export const WorksheetAnswerTypes = ['text'];
...
export const WorksheetItemSchemas = (objectId) => {
    return mapValues(WorksheetItemSchema, (schema) => z.object({}).extend(schema.shape));
};
