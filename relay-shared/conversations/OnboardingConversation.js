...
export default class OnboardingConversationManager extends RelayConversationManager {
    ...
    constructor(assignedQuestionnaireTodos, axios) {
        ...
        if (questionnaireConvos.length > 2) {
            questionnaireConvos.splice(2, 0, new BasicConversation({
                icon: faInfoCircle,
        ...
        this.addResponders({
            ...conversationUtils.createTextResponders('intro', [
                'Hello!',
            ...
            ...conversationUtils.createTextResponders('getStarted', [
                `Okay, let's get started. The first step is to look at your Wellbeing.`,
            ], conversationUtils.okButton(() => ({
                finish: true,
            }))),
        });
        this.addConversation(new BasicConversation({
            name: 'onboarding-finished',
            icon: RelayIcons.puzzlePiece,
            responders: {
                ...conversationUtils.createTextResponders('onboarding-finished', [
