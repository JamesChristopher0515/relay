...
export default makeController(function JournalEntryController(props) {
    ...
    const [checkInDoc] = useCheckIn('checkIn' in props ? props.checkIn : undefined);
    ...
    const [doc, { create, update, remove, ...journalEntryRest }] = useJournalEntryOrNew(journalEntry);
